...
const MY_STRUCT_BYTES: [u8; 57] = [
    0x42, 0x37, 0x13, 0x12, 0x34, 0x56, 0x78, 0xff, 0xaa, 0xbb, 0xcc, 0xdd, 0xaa, 0xbb, 0xcc, 0xdd,
    0xaa, 0xbb, 0xcc, 0xdd, 0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc, 0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc,
    0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc, 0x00, 0x42, 0x37, 0x13, 0x12, 0x42, 0x37, 0x13, 0x12, 0x02,
...
struct MyStruct {
    ...
    array_u16: [u16; 2],
    range_u16: Range<u16>,
    range_inclusive_u16: RangeInclusive<u16>,
...
fn deserialize_struct() {
    ...
    assert_eq!(my_struct.range_u16, 0xBBAA..0xDDCC);
    assert_eq!(my_struct.range_inclusive_u16, 0xBBAA..=0xDDCC);
...
fn serialize_struct() {
    let my_struct = MyStruct {
        ...
        range_u16: 0xBBAA..0xDDCC,
        range_inclusive_u16: 0xBBAA..=0xDDCC,
        array_sub_struct: [
            SubStruct {
                num: 0x1234,
...
fn deserialize_excess_exact() {
    ...
    const TAIL: u8 = 0xFF;
    let bytes = [
        0x42, 0x37, 0x13, 0x12, 0x34, 0x56, 0x78, 0xff, 0xaa, 0xbb, 0xcc, 0xdd, 0xaa, 0xbb, 0xcc,
        0xdd, 0xaa, 0xbb, 0xcc, 0xdd, 0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc, 0x34, 0x12, 0x56, 0x78,
        0x9a, 0xbc, 0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc, 0x00, 0x42, 0x37, 0x13, 0x12, 0x42, 0x37,
        0x13, 0x12, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, EXTRA_BYTE, TAIL,
    ];
