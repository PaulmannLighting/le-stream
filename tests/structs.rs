...
fn deserialize_two_structs() {
    let bytes = [
        ...
        0x78, 0x9a, 0xbc, 0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc, 0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc,
        0x00, 0x42, 0x37, 0x13, 0x12, 0x42, 0x37, 0x13, 0x12, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0xab, 0xcd, 0x03, 0x01, 0x02, 0x03, 0x42, 0x37, 0x13, 0x12, 0x34, 0x56, 0x78,
        0xff, 0xaa, 0xbb, 0xcc, 0xdd, 0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc, 0x34, 0x12, 0x56, 0x78,
        0x9a, 0xbc, 0x34, 0x12, 0x56, 0x78, 0x9a, 0xbc, 0x00, 0x42, 0x37, 0x13, 0x12, 0x42, 0x37,
        0x13, 0x12, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xab, 0xcd, 0x03, 0x01, 0x02,
        0x03,
    ];
...
fn deserialize_two_structs_array() {
    ...
    let structs = <[MyStruct; 2]>::from_le_stream(bytes.into_iter())
        .expect("Could not create struct from byte stream.");
...
fn deserialize_from_slice() {
    ...
    let my_struct =
        MyStruct::from_le_slice(&bytes).expect("Could not create struct from byte stream.");
